...
def propagate(w, b, X, Y):
    ...
    A =  sigmoid( X.T.dot(w) + b).T                 # compute activation
...
d = model(train_set_x, train_set_y, test_set_x, test_set_y, num_iterations = 3000, learning_rate = 0.0005, print_cost = True)
